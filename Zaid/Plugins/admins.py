...
from Zaid.MusicUtilities.helpers.filters import command, other_filters
...
from Zaid.MusicUtilities.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
...
from Zaid.MusicUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup, audio_markup)
from Zaid.MusicUtilities.tgcallsrun import (convert, download)
...
async def member_permissions(chat_id: int, user_id: int):
    ...
    return perms
from Zaid.MusicUtilities.helpers.administrator import adminsOnly
